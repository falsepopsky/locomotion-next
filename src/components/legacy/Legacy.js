...
import { BoxSection, StyledH3 } from './Legacy.styles';
import { StyledH2, StyledP } from '../ui/Styles';
    ...
    <>
      ...
      <BoxSection>
        ...
        <StyledP>
          ...
          adultos del antiguo canal de cable <b>Locomotion</b>, de los cuales
          los principales responsables y sitios oficiales son:{' '}
        ...
        <StyledP>
          ...
          oficial seguía y sigue sufriendo de constantes ataques DDoS el cuál
          imposibilita visitar la página y ver el stream o directamente, no
          podías saber que programa venía a continuación.
        </StyledP>
        ...
        <ol>
          ...
          <li>
            ...
            &#40;página principal&#41;, como semanal.
          </li>
          <li>
            Trabajar con NEXT JS, que es un framework que lo aprendí y tomé
            demasiado aprecio por las cosas que ofrece.
          </li>
        </ol>
      </BoxSection>
      <BoxSection>
        ...
        <StyledH3>
          ¿Te contactaste con los dueños de la página para ver si podian mejorar
          la página o trabajar con ellos?
        </StyledH3>
        <StyledP>
        ...
        <StyledH3>
          Cuando pongo PLAY, no se me reproduce nada y queda todo en negro.
        </StyledH3>
        <StyledP>
        ...
        <StyledP>
          Primero que nada los horarios están para la región de Argentina y en
          segundo lugar puede que cambiaron los programas.
        </StyledP>
      </BoxSection>
    </>
  );
